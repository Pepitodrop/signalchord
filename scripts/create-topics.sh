#!/usr/bin/env sh
set -eu
TOPICS="source.registered.v1 source.poll.requested.v1 source.document.discovered.v1 source.document.fetched.v1 document.normalized.v1 document.duplicate-detected.v1 document.nlp-requested.v1 document.nlp-completed.v1 entity.mention-extracted.v1 entity.resolution-requested.v1 entity.resolved.v1 claim.extracted.v1 claim.clustered.v1 claim.contradiction-detected.v1 relationship.extracted.v1 graph.mutation-requested.v1 graph.mutation-completed.v1 graph.analytics-requested.v1 intelligence.signal-created.v1 alert.policy-evaluation-requested.v1 alert.created.v1 notification.requested.v1 audit.event.v1"
